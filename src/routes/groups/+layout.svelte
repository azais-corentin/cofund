	...
	<div id="groups-header" class="flex flex-col gap-6">
		<div class="flew-row flex gap-4">
			<div class="flex flex-1 flex-col">
				...
				<div>
					<p class="text-l tracking-tight text-muted-foreground">Manage your shared expenses</p>
				</div>
			</div>
			<div class="content-center">
				<Button><Plus /> New group</Button>
			</div>
		</div>
		<div>
			<div class="relative">
				...
				/>
				<Input placeholder="Filter groups" class="pl-8">qdqsd</Input>
			</div>
		</div>
	</div>
